...
def fake_request(monkeypatch):
    ...
    def _fake(method, url, headers=None, params=None, json_body=None, timeout=None):
        ...
        if "/tweets/search/recent" in url:
            return FakeResponse(200, {"data": [{"id": "t1", "author_id": "u55", "public_metrics": {}}], "includes": {"users": [{"id": "u55", "username": "agent"}]}, "meta": {}})
...
@pytest.mark.parametrize("method_name, arg", [("delete_post", "del123"), ("like_post", "l5"), ("unlike_post", "l5"), ("retweet", "r7"), ("unretweet", "r7"), ("follow_user", "u99")])
