...
Moves orchestration from src/actions.py and src/scheduler.py to this module.
"""
...
from business.content import choose_template
from business.content import helpful_reply
...
def act_on_search(
    ...
    """Perform reply, like, follow, and repost actions up to limits.

    This function is the orchestration glue: calls search, applies filters,
    enforces quotas and jitter, and logs results.
    """
    import time
